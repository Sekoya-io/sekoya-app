...
import sekoya.front.notification.page.ExampleHtmlNotificationPage;
import sekoya.front.notification.page.UserPasswordRecoveryRequestHtmlNotificationPage;
...
public class SekoyaNotificationContentDescriptorFactoryImpl
    extends AbstractNotificationContentDescriptorFactory
    implements ISekoyaNotificationContentDescriptorFactory {

  @Autowired
  public SekoyaNotificationContentDescriptorFactoryImpl(IWicketContextProvider contextProvider) {
  ...
  public INotificationContentDescriptor example(User user, Instant instant) {
    return new AbstractSimpleWicketNotificationDescriptor("notification.panel.example") {
      ...
      public Page createPage(Locale locale) {
        return new ExampleHtmlNotificationPage(
            GenericEntityModel.of(user), Model.of(instant), Model.of(locale));
      }
  ...
  public INotificationContentDescriptor userPasswordRecoveryRequest(User user, Instant instant) {
    ...
    ResourceKeyGenerator keyGenerator =
    ...
    return new AbstractSimpleWicketNotificationDescriptor(keyGenerator.resourceKey()) {
      ...
      public Page createPage(Locale locale) {
        ...
        return new UserPasswordRecoveryRequestHtmlNotificationPage(
            ...
            mapper.map(
                userModel,
                BindingModel.of(userModel, Bindings.user().passwordRecoveryRequest().token())),
            Model.of(locale));
      }
