...
import sekoya.front.history.component.CompositeHistoryDifferencePanel;
import sekoya.front.history.component.DefaultHistoryDifferencePanel;

/**
 * A {@link IHistoryComponentFactory} allowing the caller to customize the way some particular
...
public class CustomizableHistoryComponentFactory implements IHistoryComponentFactory {
  ...
  private final Map<FieldPath, IHistoryComponentFactory> specificComponentFactories =
      Maps.newHashMap();
  ...
  public CustomizableHistoryComponentFactory customForPath(
      FieldPath path, IHistoryComponentFactory factory) {
    specificComponentFactories.put(path, factory);
    return this;
  }

  /** Use a custom {@link IHistoryComponentFactory} for the given field. */
  public CustomizableHistoryComponentFactory customForBinding(
      BindingRoot<?, ?> binding, IHistoryComponentFactory factory) {
  ...
  public CustomizableHistoryComponentFactory customForBindingItem(
      BindingRoot<?, ?> binding, IHistoryComponentFactory factory) {
   ...
   */
  public CustomizableHistoryComponentFactory compositeBlockForBindingItem(
      BindingRoot<?, ?> binding) {
    return customForBindingItem(binding, compositeBlockFactory);
  }

  /**
   * Use the {@link CompositeHistoryDifferencePanel#inline(IHistoryComponentFactory) inline
   * composite} layout for the given field.
   */
  ...
  /**
   * Use the {@link CompositeHistoryDifferencePanel#inline(IHistoryComponentFactory) inline
   * composite} layout for the given field's items.
   */
  public CustomizableHistoryComponentFactory compositeInlineForBindingItem(
      BindingRoot<?, ?> binding) {
