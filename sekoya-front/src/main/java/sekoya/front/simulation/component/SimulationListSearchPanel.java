...
public class SimulationListSearchPanel extends Panel {
  ...
  public SimulationListSearchPanel(
    ...
    form.add(
        new EnumDropDownSingleChoice<>("scenario", scenarioModel, Scenario.class)
            .setLabel(new ResourceModel("business.common.scenario"))
            .setRequired(true)
            .add(new LabelPlaceholderBehavior()),
        new EnumDropDownSingleChoice<>("horizon", horizonModel, Horizon.class)
            .setLabel(new ResourceModel("business.common.horizon"))
            .setRequired(true)
            .add(new LabelPlaceholderBehavior()),
        new CheckBox("applyProcessus", applyProcessusModel)
