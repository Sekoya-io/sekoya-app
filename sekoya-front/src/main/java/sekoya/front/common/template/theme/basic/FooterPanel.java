...
import sekoya.back.util.time.DateTimePattern;
...
public class FooterPanel extends Panel {
  ...
  public FooterPanel(String id) {
    ...
    add(
        ...
        new CoreLabel(
                "sha",
                Condition.hasText(ApplicationPropertyModel.of(SekoyaBackPropertyIds.BUILD_SHA))
                    .then(ApplicationPropertyModel.of(SekoyaBackPropertyIds.BUILD_SHA))
