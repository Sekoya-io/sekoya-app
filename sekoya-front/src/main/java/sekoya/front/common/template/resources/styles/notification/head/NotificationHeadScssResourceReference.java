package sekoya.front.common.template.resources.styles.notification.head;
...
public final class NotificationHeadScssResourceReference extends ScssResourceReference {
  ...
  private static final NotificationHeadScssResourceReference INSTANCE =
      new NotificationHeadScssResourceReference();
