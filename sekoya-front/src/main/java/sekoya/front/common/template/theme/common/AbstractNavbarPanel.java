...
public abstract class AbstractNavbarPanel extends Panel {
  ...
  protected void addNavItem(
    ...
    add(navItem.anyChildVisible().add(component));
  }

  protected void addActiveClass(
      ListItem<NavigationMenuItem> item, Class<? extends Page> clazz, Component component) {
    addActiveClass(item.getModelObject()::isActive, clazz, component);
  }

  protected void addActiveClass(
      IPageLinkGenerator pageLinkGenerator, Class<? extends Page> clazz, Component component) {
    addActiveClass(pageLinkGenerator::isActive, clazz, component);
  }
