...
public class ReferenceDataAjaxDropDownMultipleChoice<
        T extends ReferenceData<? super T>, C extends Collection<T>>
    extends GenericSelect2AjaxDropDownMultipleChoice<T> {
