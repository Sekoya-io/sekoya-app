package sekoya.front.console.notification.demo.page;
...
import sekoya.back.business.notification.service.INotificationService;
...
import sekoya.front.console.notification.demo.template.ConsoleNotificationDemoTemplate;
import sekoya.front.console.notification.demo.util.ConsoleNotificationDemoEntry;
  ...
  public ConsoleNotificationDemoListPage(PageParameters parameters) {
    ...
    add(
        new Link<Void>("sendExample") {
          ...
          public void onClick() {
            try {
              notificationService.sendExampleNotification(SekoyaSession.get().getUser());
