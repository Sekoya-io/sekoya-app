insert into role (id, title, enumkey)
...
values (-1, '2024-09-27 14:55:47.143', true, '2024-09-27 14:55:47.143',
        '{bcrypt}$2a$10$ii8ZZCYp9rt04V6Qawn1b.7MpQrd022rMr4sUTcJFCpc9ra8EL0Iu', 'USER_ORGANISATION_USERNAME_WITHOUT_PERMISSIONS',
        'user1@kobalt.fr', 'user1', 'user1', true, 'ORGANISATION'),
       (-2, '2024-09-27 14:55:47.575', true, '2024-09-27 14:55:47.575',
        '{bcrypt}$2a$10$cvNfP3PFWq1jnIlXf8W4Y.KruhmBY31Gcc4pIG7B/Ocxq8Au0xkwa', 'USER_ADMINISTRATEUR_TECHNIQUE_USERNAME', 'user2@kobalt.fr',
        'user2', 'user2', true, 'ADMINISTRATEUR_TECHNIQUE'),
       (-3, '2024-09-27 14:55:47.708', true, '2024-09-27 14:55:47.785',
        '{bcrypt}$2a$10$04tR9JXLBZ2TefixidU5j.6HCn5r.IE7w8vc0VJpvzcJg4vGm6bXa', 'USER_ORGANISATION_USERNAME_WITH_PERMISSIONS',
        'user3@kobalt.fr', 'user3', 'user3', true, 'ORGANISATION');
