...
import static sekoya.back.property.SekoyaBackPropertyIds.SECURITY_PASSWORD_VALIDATOR_ENABLED;
...
@Configuration
public class SekoyaBackPropertyRegistryConfiguration implements IPropertyRegistryConfiguration {
