...
public enum CitySort implements ISort<Function<SearchSortFactory, SortFinalStep>> {
  ...
  ID {
    @Override
    public List<Function<SearchSortFactory, SortFinalStep>> getSortFields(SortOrder sortOrder) {
      return List.of(f -> f.field(City.ID).order(toSortOrder(this, sortOrder)));
    }
  ...
  POSITION {
    @Override
    public List<Function<SearchSortFactory, SortFinalStep>> getSortFields(SortOrder sortOrder) {
      return List.of(f -> f.field(City.POSITION).order(toSortOrder(this, sortOrder)));
    }
  ...
  POSTAL_CODE {
    @Override
    public List<Function<SearchSortFactory, SortFinalStep>> getSortFields(SortOrder sortOrder) {
      return List.of(f -> f.field(City.POSTAL_CODE).order(toSortOrder(this, sortOrder)));
    }
