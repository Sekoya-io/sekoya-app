...
public class LocalizedText extends AbstractLocalizedText {
  ...
  public String get(Locale locale) {
    ...
    if (SekoyaLocale.FRENCH.getLanguage().equals(locale.getLanguage())) {
      return getFr();
    } else if (SekoyaLocale.ENGLISH.getLanguage().equals(locale.getLanguage())) {
      return getEn();
    } else {
      return get(SekoyaLocale.DEFAULT);
    }
  }
