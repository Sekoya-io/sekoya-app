...
public enum ProcessusType {
  ...
  APPROVISIONNEMENT_EAU_PRINCIPAL_QUANTITE(ProcessusThematique.EAU, "fa-faucet-drip"),
  APPROVISIONNEMENT_EAU_PRINCIPAL_QUALITE(ProcessusThematique.EAU, "fa-droplet"),
