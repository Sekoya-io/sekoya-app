...
create table Site (id bigint not null, actif boolean not null, adresse_adresse1 varchar(255) not null, adresse_adresse2 varchar(255), adresse_codePostal varchar(5) not null, chiffreAffaires integer, creation_date timestamp(6) with time zone not null, creation_subject_label text, creation_subject_reference_id bigint, creation_subject_reference_type varchar(255), creation_subject_serialized text, latitude numeric(8,6), longitude numeric(9,6), modification_date timestamp(6) with time zone not null, modification_subject_label text, modification_subject_reference_id bigint, modification_subject_reference_type varchar(255), modification_subject_serialized text, nom varchar(255) not null, typologie varchar(255) not null check ((typologie in ('TYPOLOGIE1','TYPOLOGIE2'))), adresse_commune_id bigint not null, organisation_id bigint not null, primary key (id));
