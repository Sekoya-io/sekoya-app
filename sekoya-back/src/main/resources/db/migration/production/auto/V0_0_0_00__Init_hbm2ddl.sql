...
create table City (id bigint not null, deleteable boolean not null, disableable boolean not null, editable boolean not null, enabled boolean not null, position integer not null, label varchar(255), postalCode varchar(255) not null, primary key (id), unique (label, postalcode));
